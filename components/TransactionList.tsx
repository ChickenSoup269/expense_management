          ...
          {selectedIds.length > 0 ? (
            ...
            <div className="flex justify-between items-center bg-blue-50 dark:bg-blue-900/20 -m-2 p-3 rounded-lg border border-blue-100 dark:border-blue-900/30">
              <div className="flex items-center gap-3">
                ...
                <span className="text-blue-900 dark:text-blue-200 font-medium text-sm">
                  đã chọn
                </span>
              </div>
              ...
              {filteredTransactions.map((t) => (
                ...
                >
                  ...
                  <div className="hidden md:grid grid-cols-12 gap-4 p-4 items-center text-sm text-slate-700 dark:text-slate-300">
                    ...
                    <div className="col-span-3 truncate font-medium text-slate-700 dark:text-slate-300">
                      {t.note}
                    </div>
                    <div
                      ...
                      <div className="flex flex-col items-end gap-2">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="text-slate-400 dark:text-slate-500 hover:text-blue-600 dark:hover:text-blue-400 p-1"
                          >
                            <Edit2 size={18} />
                          </button>
                          <button
